...
The note is the usual "New submission". The package URL points at a repository
that is created alongside this submission.
...
This is a new submission. It implements the estimation and inference procedures
of Sun, Guo, Li, Tu and Sun (2024), *Bernoulli* **30**(4), 3251-3275,
<doi:10.3150/23-BEJ1713>, which is cited in the DESCRIPTION and in `inst/CITATION`.
